		...
		<section className="overflow-hidden rounded-2xl border border-border bg-card shadow-sm">
			<div className="flex flex-col justify-between gap-4 border-b border-border p-6 pb-5 md:flex-row md:items-center">
				<div className="flex items-center gap-3">
					<h3 className="text-lg font-bold tracking-tight text-foreground">All Patients</h3>
							...
							filteredPatients.map((patient) => {
								...
								return (
									...
									>
										...
										<td className="px-4 py-4 font-medium whitespace-nowrap text-foreground">{clinicName}</td>
